...
{
    protected \app\model\system\SystemUpgradeLog $model;
    ...
    protected function initialize(): void
    {
        ...
        $this->model = new \app\model\system\SystemUpgradeLog();
    }
    ...
    public function isUpgrade(string $module = '', string $filename = ''): bool
    {
        ...
        $query = $this->model->where('module', $module)->where('filename', $filename)->findOrEmpty();
    ...
    public function install(): bool
    {
        ...
        foreach ($files as $module => $moduleFiles) {
            foreach ($moduleFiles as $fileOrClass) {
                ...
                $this->model->create(['module' => $module,
