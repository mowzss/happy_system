...
class Login extends Controller
{
    ...
    public function wxxcx(): void
    {
        ...
        $uid = $user_oauth->where(['type' => 'wxxcx', 'openid' => $wx_user_info['openid']])->value('id');
        if (!empty($uid)) {  //包含uid 则说明已创建用户
            ...
            $user->avatar = $wx_user_info['avatar'] ?? '';
        ...
        try {
            ...
            $this->json($data, 0, '登录成功');
        } catch (InvalidArgumentException $e) {
            $this->json(['code' => 500, 'message' => $e->getMessage()]);
        }
    }
}
