...
VALUES (1, 'storage_driver', 'radio', '存储引擎', 4,
       ...
       (37, 'square_logo', 'image', '方形LOGO', 1, '', '后台，二维码等场景使用', '', NULL, 0, 'system', 1, 1736227701,
        1736439835),
       (38, 'home_pc_style', 'select', '网站PC风格', 1,
        '\\happy\\admin\\libs\\helper\\TemplateHelper@getTemplateData@home', '',
        'default', NULL, 0, 'system', 1, 1736259709, 1736262456),
       (39, 'home_wap_style', 'select', '网站wap风格', 1,
        '\\happy\\admin\\libs\\helper\\TemplateHelper@getTemplateData@home',
        '', 'default', NULL, 0, 'system', 1, 1736259735, 1736261908),
       (40, 'admin_style', 'select', '后台风格', 1,
        '\\happy\\admin\\libs\\helper\\TemplateHelper@getTemplateData@admin', '',
        'default', NULL, 0, 'system', 1, 1736259762, 1736261908),
       (41, 'user_pc_style', 'select', '会员PC风格', 1,
        '\\happy\\admin\\libs\\helper\\TemplateHelper@getTemplateData@user', '',
        'default', NULL, 0, 'system', 1, 1736259818, 1736264408),
       (42, 'user_wap_style', 'select', '会员wap风格', 1,
        '\\happy\\admin\\libs\\helper\\TemplateHelper@getTemplateData@user',
