...
class Base extends Controller
{
    ...
    protected function initialize(): void
    {
        ...
        $this->mobile_url = ($this->web_config['system']['site_wap_domain'] ?? $this->web_config['system']['site_domain']) . $this->request->url();
        $this->pc_url = $this->web_config['system']['site_domain'] . $this->request->url();
